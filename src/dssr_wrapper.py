...
if __name__ == "__main__":
	...
	input_files=os.listdir("data/TrainingSet")
	for in_path in input_files:
		new_input = f"data/TrainingSet/{in_path}"
		out_name = f"data/TrainingSetAngles/{in_path}"
		dssr_wrapper.run(new_input, out_name, False)
